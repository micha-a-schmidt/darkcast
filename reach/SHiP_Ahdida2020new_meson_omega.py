...
states from omega mesons and was provided by the authors
of Ahdida:2020new.
"""
bibtex = """
...
production = darkcast.Production("omega_pi0")
decay = ["e_e", "mu_mu", "pi+_pi-", "pi+_pi-_pi0_pi0", "pi+_pi-_pi0",
         "pi+_pi-_pi+_pi-", "other"]
bounds = darkcast.Datasets("reach/SHiP_Ahdida2020new_meson_omega.lmt")
