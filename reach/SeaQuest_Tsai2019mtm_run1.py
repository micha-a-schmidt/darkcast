...
import darkcast
notes = """
This projection corresponds to figure 3b (dashed blue curve labeled
SQ/DQ (1e18 POT)) of Tsai:2019mtm and was provided directly by the
authors. A total of 1e18 protons on target is assumed for run 1 data
taking.
...
decay = ["e_e", "mu_mu"]
bounds = darkcast.Datasets("reach/SeaQuest_Tsai2019mtm_run1.lmt")
