...
production = darkcast.Production("eta'_gamma")
decay = ["e_e","mu_mu","pi+_pi-","pi+_pi-_pi0_pi0","pi+_pi-_pi0","pi+_pi-_pi+_pi-","other"]
bounds = darkcast.Datasets("reach/SHiP_meson_etaprime_double.lmt")
